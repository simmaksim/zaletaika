...
// import Conversations from 'twilio-video'
...
//             return fetch(`${apiPath}/api/video/get-token/`, {
//                 method: 'POST',
//                 headers: new Headers({
...
//     return Conversations.Client.create(token).then(_chat => {
//         chat = _chat;
